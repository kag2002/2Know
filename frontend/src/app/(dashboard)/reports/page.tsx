    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border-none shadow-sm bg-background">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Lượt nộp bài (Hệ thống)</CardTitle>
        ...
        <Card className="border-none shadow-sm bg-background">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Điểm trung bình (Hệ thống)</CardTitle>
              ...
              <div key={quiz.id} className="p-5 flex flex-col sm:flex-row gap-4 items-start sm:items-center hover:bg-muted transition-colors">
                ...
                <div className="flex gap-8 sm:gap-12 text-center shrink-0">
                  <div className="flex flex-col opacity-50">
                    ...
                    <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Bài nộp</span>
                  </div>
                  <div className="flex flex-col opacity-50">
                    <span className="text-xl font-bold text-emerald-600">---</span>
                    <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Điểm TB</span>
                  </div>
                </div>

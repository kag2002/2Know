    ...
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-slate-950 text-slate-50 relative overflow-hidden -m-6 sm:-m-8">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 flex justify-between items-center p-4 bg-gradient-to-b from-black/80 to-transparent">
        ...
        <div className="flex items-center gap-2">
          <Button variant="ghost" className="text-white hover:bg-white/20" onClick={startCamera}>
          ...
          <>
            ...
            {scanResult && (
              <div className="absolute inset-0 flex items-center justify-center z-30 bg-slate-950/40 backdrop-blur-sm p-4 animate-in zoom-in-95 duration-300">
                <div className="bg-white text-slate-900 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col">
                  {/* Result Header */}
                  <div className="bg-emerald-50 border-b border-emerald-100 p-6 text-center relative overflow-hidden">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800">Chấm điểm thành công!</h2>
                  ...
                  <div className="p-6 grid grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm text-slate-500 font-medium mb-1">Số Báo Danh (SBD)</p>
                    ...
                    <div className="flex flex-col items-center justify-center bg-slate-50 rounded-xl border border-slate-100 p-4">
                      <p className="text-sm text-slate-500 font-medium mb-2 uppercase tracking-wider">Tổng điểm</p>
                  ...
                  <div className="px-6 pb-4">
                    ...
                    <div className="h-24 bg-slate-100 rounded-lg overflow-hidden relative border border-slate-200">
                  ...
                  {/* Bottom Actions */}
                  <div className="p-4 bg-slate-50 grid grid-cols-2 gap-3 border-t">

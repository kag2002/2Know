              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full ${quiz.status === "active" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400" : "bg-slate-100 text-slate-500"}`}>
                      {quiz.status === "active" ? "Đang mở" : "Hết hạn"}
                    </span>
                    <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${quiz.type === "public" ? "bg-blue-100 text-blue-700" : "bg-amber-100 text-amber-700"}`}>

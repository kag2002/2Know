  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
      <div className="text-center space-y-3">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Tạo tài khoản Giáo viên</h1>
        <p className="text-slate-500">Bắt đầu miễn phí, không cần thẻ tín dụng</p>
      </div>
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100/50">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button className="h-11 flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-sm font-medium text-slate-700 transition-colors">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-3 text-slate-400 font-medium">Hoặc đăng ký bằng Email</span></div>
        </div>
